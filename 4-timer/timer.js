...
let mes = document.querySelector('.mes__stay').innerText;
let day = document.querySelector('.day__stay').innerText;
let hour = document.querySelector('.hour__stay').innerText;
let minute = document.querySelector('.minute__stay').innerText;
let second = document.querySelector('.second__stay').innerText;
